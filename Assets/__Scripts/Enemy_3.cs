...
using UnityEngine;
/// <summary>
/// Расширяет класс Enemy, движется потем линейной интерполяции кривой Безье по более чем двум точкам
/// </summary>
public class Enemy_3 : Enemy
{
    ...
    void Start()
    {
        ...
        // Случайно выбрать среднюю точку выше верхней границы экрана
        v = Vector3.zero;
        v.x = Random.Range(xMin, xMax);
        v.y = pos.y;
        points[2] = v;
    ...
    public override void Move()
    {
        ...
        Vector3 p01, p12;
        u = u - 0.2f * Mathf.Sin(u * Mathf.PI * 2); // Сглаживает движение
